...
const DeletePopup: React.FC<props> = ({
  ...
  return (
    <div>
      ...
      >
        <div className="fixed left-1/2 top-1/2 flex w-[90%] max-w-[360px] -translate-x-1/2 -translate-y-1/2 flex-col items-center gap-4 rounded-xl bg-white p-4 py-5">
          <Image src={"/img.png"} className="w-12" alt="bin" />
          <Typography
          ...
          <div className="flex w-full items-center justify-center gap-4 self-start border-t border-[#F1F2F3] pt-4">
            ...
            <Button onClick={proceedCallback} color="error">
              {proceedText}
            </Button>
          </div>
        </div>
