...
import { authRedirect, storageCheckOrRedirect } from "../helpers";
...
type GeneralStoragePickerProps = {
  onClose: () => void;
  mimeType: mime_;
  provider?: DocumentPlatform;
...
const GeneralStoragePicker: React.FC<GeneralStoragePickerProps> = ({
  onClose,
  provider,
...
export default GeneralStoragePicker;
